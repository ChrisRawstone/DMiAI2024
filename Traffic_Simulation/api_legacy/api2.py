...
def compute_pareto_solution(leg_data, current_phase, delta_t, saturation_flow_rate, yellow_time, min_green_time, max_green_time, green_durations, stay_will):
...
delta_t = 5.33
saturation_flow_rate = 1.58  # Vehicles per second per leg
yellow_time = 5.66
min_green_time = 6
max_green_time = 30
stay_will = 0.6
